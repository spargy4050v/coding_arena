    ...
    <div className="h-full w-full flex flex-col">
      {availableLanguages.length > 0 && onLanguageChange && (
        <div className="bg-gray-800 border-b border-gray-700 px-4 py-2 flex items-center gap-2">
          <label htmlFor="language-selector" className="text-gray-300 text-sm">
            Language:
          </label>
          <select
            ...
            className="bg-gray-700 text-white border border-gray-600 rounded px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 hover:border-gray-500"
          >
        ...
        <Suspense fallback={
          <div className="h-full w-full flex items-center justify-center bg-gray-900 text-white">
            <div className="text-center">
              ...
              <div className="text-lg mb-2">Loading Editor Container...</div>
            </div>
          </div>
        }>
          <Editor
